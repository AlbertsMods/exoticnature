package com.tuppymsm.exoticnature.item.custom;

import com.google.common.collect.ImmutableMap;
import com.tuppymsm.exoticnature.item.ModArmourMaterial;
...
import java.util.Map;
 ...
 public class GacArmourItem extends ArmorItem {
     private static final Map<ArmorMaterial, MobEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffect>())
                    .put(ModArmourMaterial.GAC, MobEffects.ABSORPTION).build();

    public GacArmourItem(ArmorMaterial material, EquipmentSlot slot, Properties settings) {
